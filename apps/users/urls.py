...
from apps.users.views.email_auth import (
    EmailRegisterRequestView,
    VerifyEmailView,
    ResendCodeView
)
...
urlpatterns = [
    ...
    # Email Verification (YANGI)
    path('auth/email/register/', EmailRegisterRequestView.as_view(), name='email-register-request'),
    path('auth/email/verify/', VerifyEmailView.as_view(), name='email-verify'),
    path('auth/email/resend/', ResendCodeView.as_view(), name='email-resend-code'),
]